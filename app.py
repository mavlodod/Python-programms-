...
# Импортируем модуль уведомлений (ваш файл send_notification.py)
try:
    from send_notification import send_telegram_notification
    HAS_TELEGRAM = True
    print("✅ Модуль Telegram уведомлений загружен")
except ImportError as e:
    HAS_TELEGRAM = False
    print(f"⚠️  Модуль Telegram уведомлений не найден: {e}")
